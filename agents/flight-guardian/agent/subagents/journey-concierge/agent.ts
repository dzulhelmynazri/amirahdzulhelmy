...
export default defineAgent({
  build: {
    externalDependencies: ["@composio/core", "@composio/experimental"],
  },
  compaction: {
    thresholdPercent: 0.75,
  },
  description:
    "Connects flights to ground transport, hotel timing, Gmail, Calendar, and Maps. Also writes trip itineraries to /trips. Does not book or rebook flights.",
  limits: {
