...
export default defineEval({
  ...
  async test(t) {
    await t.send(
      "Book a one-way from SIN to LHR on 2026-12-15 for 1 adult. Hand this to the booking specialist with those details. Do not create an order or take payment yet."
    );
    t.succeeded();
