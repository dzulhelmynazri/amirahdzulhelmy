...
export default defineEval({
  ...
  async test(t) {
    await t.send(
      "Search one-way fares from SIN to LHR on 2026-08-25 for 1 adult. I confirm those details. Use flight-search, not route-export. Rank a short cheap list. Do not book."
    );
    t.succeeded();
