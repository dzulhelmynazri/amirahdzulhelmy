...
import { Loader } from "@atlas/ui/components/motion/loader";
import { TextScramble } from "@atlas/ui/components/motion/text-scramble";
import { EASE_OUT, SPRING_SWAP } from "@atlas/ui/lib/ease";
import {
  TEXT_SHIMMER_CLASS_NAME,
  TEXT_SHIMMER_KEYFRAMES,
  textShimmerStyle,
} from "@atlas/ui/lib/text-shimmer";
...
export function ReasoningText({
  ...
  const phrase =
    safePhrases[index % safePhrases.length] ?? safePhrases[0] ?? "";
